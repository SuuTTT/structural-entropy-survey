\begin{abstract}
Graphs and networks are now a common language for artificial intelligence,
from social and biological interaction systems to knowledge graphs, retrieval
pipelines, and autonomous-agent workflows.
A central challenge in these settings is to identify meaningful organization
